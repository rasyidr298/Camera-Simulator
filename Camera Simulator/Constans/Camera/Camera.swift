...
class Camera : NSObject {
    ...
    override init() {
        ...
        print("maxISO: \(String(describing: maxISO))")
        print("minISO: \(String(describing: minISO))")
        print("maxExposureDuration: \(String(describing: maxExposureDuration))")
        print("minExposureDuration: \(String(describing: minExposureDuration))")
        print("maxExposureTargetBias: \(String(describing: maxExposureTargetBias))")
        print("minExposureTargetBias: \(String(describing: minExposureTargetBias))")
